...
def _get_base_url() -> str:
    ...
    Validates X-Forwarded-Host against TRUSTED_FORWARD_HOSTS config
    to prevent Host header injection. Falls back to request.host_url
    if the forwarded host is not trusted.
    """
