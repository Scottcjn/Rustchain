...
Run with coverage:
    pytest tests/test_bottube.py --cov=rustchain.bottube
"""
...
from rustchain.bottube import BoTTubeClient, BoTTubeError, UploadError
from rustchain.bottube.exceptions import AuthenticationError, APIError
...
class TestHealthEndpoint:
    ...
    @patch("rustchain.bottube.client.urllib.request.urlopen")
...
class TestCreateClient:
    ...
    def test_create_client(self):
        ...
        from rustchain.bottube import create_client
