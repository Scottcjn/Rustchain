...
### `RustChainClient(base_url, verify_ssl, ca_bundle_path, timeout, max_retries, retry_delay)`

| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `base_url` | str | `https://50.28.86.131` | Node URL |
| `verify_ssl` | bool | `True` | Verify SSL certificates |
| `ca_bundle_path` | str \| None | `None` | Path to a CA bundle (useful for self-signed node certs) |
