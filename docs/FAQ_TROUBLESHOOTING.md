...
### 5) Is self-signed TLS expected on the public node API?

No. The public `https://rustchain.org` endpoint validates with the system trust
store:
...
Check the public endpoint with normal TLS verification:
