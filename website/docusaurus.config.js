    ...
    [
      ...
      ({
        docs: {
          ...
          // Exclude partial translation dirs: they use GitHub-relative links
          // that don't resolve as routes (the bulk of broken-link warnings)
          // and clutter the autogenerated sidebar. Content stays in the repo.
          exclude: [
            'de-DE/**', 'es-ES/**', 'fr-FR/**', 'it-IT/**', 'ja-JP/**',
            'ko-KR/**', 'nl-NL/**', 'pl-PL/**', 'pt-BR/**', 'vi-VN/**',
            'zh-CN/**', 'es/**', 'ja/**', 'i18n/**',
          ],
          editUrl:
