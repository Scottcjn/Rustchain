...
def simulate_dust_inflation():
    ...
    conn.execute(
        "INSERT INTO utxo_boxes (box_id, value_nrtc, owner_address, spent_at) VALUES ('box1', 10000, 'attacker', NULL)"
    )
    ...
    conn.execute(
        "INSERT INTO utxo_boxes (box_id, value_nrtc, owner_address, spent_at) VALUES ('box2', 9500, 'attacker', NULL)"
    )
