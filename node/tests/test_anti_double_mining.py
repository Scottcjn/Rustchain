...
class TestMachineIdentity(unittest.TestCase):
    ...
    def test_different_arch_different_identity(self):
        ...
        fingerprint = {"checks": {"clock_drift": {"data": {"cv": 0.001, "mean_ns": 100.0}}}}
    ...
    def test_normalize_fingerprint_extract_serial(self):
        ...
        fingerprint = {"checks": {"cpu_serial": {"data": {"serial": "TEST-SERIAL-123"}}}}
    ...
    def test_normalize_fingerprint_extract_clock(self):
        ...
        fingerprint = {"checks": {"clock_drift": {"data": {"cv": 0.001234, "mean_ns": 123.456}}}}
...
class TestDuplicateDetection(unittest.TestCase):
    ...
    def test_detect_same_machine_multiple_miners(self):
        ...
        fingerprint = json.dumps({"checks": {"cpu_serial": {"data": {"serial": "SAME-MACHINE-123"}}}})
        ...
        duplicates = detect_duplicate_identities(
            self.conn, epoch=0, epoch_start_ts=epoch_start_ts, epoch_end_ts=epoch_start_ts + 144 * 600
        )
    ...
    def test_no_duplicates_distinct_machines(self):
        ...
        for i in range(3):
            fingerprint = json.dumps({"checks": {"cpu_serial": {"data": {"serial": f"UNIQUE-MACHINE-{i}"}}}})
...
class TestRepresentativeSelection(unittest.TestCase):
    ...
    def test_select_highest_entropy(self):
        ...
        miners = [("miner-low", 0.03), ("miner-mid", 0.06), ("miner-high", 0.09)]
    ...
    def test_select_most_recent_on_tie(self):
        ...
        base_ts = 1728000000
        miners = [("miner-old", base_ts), ("miner-new", base_ts + 1000)]
...
class TestIdempotency(unittest.TestCase):
    ...
    def test_idempotent_reward_calculation(self):
        ...
        for i, (rewards, _) in enumerate(results[1:], 1):
            self.assertEqual(first_rewards, rewards, f"Run {i} should produce same rewards as run 0")
    ...
    def test_idempotent_representative_selection(self):
        ...
        for i, reps in enumerate(representatives[1:], 1):
            self.assertEqual(representatives[0], reps, f"Run {i} should select same representatives as run 0")
