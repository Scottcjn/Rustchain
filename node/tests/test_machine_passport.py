...
class TestMachinePassportLedger(unittest.TestCase):
    ...
    def test_update_passport(self):
        ...
        success, msg = self.ledger.update_passport("update_test", {"name": "Updated Name", "architecture": "NewArch"})
    ...
    def test_export_passport_full(self):
        ...
        # Add some data
        self.ledger.add_repair_entry("export_test", int(time.time()), "maintenance", "General maintenance")
...
class TestQRCodeGeneration(unittest.TestCase):
    ...
    def test_generate_qr_code(self):
        ...
        try:
            success, msg = generate_qr_code("https://rustchain.org/passport/test123", tmp_path)
...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def setUp(self):
        ...
        machine_passport_api.PASSPORT_DB_PATH = tempfile.NamedTemporaryFile(delete=False, suffix=".db").name
