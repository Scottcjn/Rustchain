...
class NFTBadgeGenerator:
    ...
    BADGE_TYPES = {
        ...
        "FIRST_BLOCK": {"name": "First Block", "description": "Mined your first block", "tier": "common", "icon": "🎯"},
        "HARDWARE_DIVERSITY": {
...
<svg width="300" height="350" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="10" y="10" width="280" height="330" rx="20" ry="20"
        ...
        {'filter="url(#glow)"' if template["glow"] else ""}/>
  ...
  <text x="150" y="320" font-family="Arial" font-size="12" text-anchor="middle" fill="#FFFFFF" opacity="0.7">
    ...
    def generate_badge_metadata(self, badge_type: str, miner_info: Dict, block_height: int) -> Dict:
        ...
        metadata = {
            ...
            "attributes": [
                {"trait_type": "Badge Type", "value": badge_type},
                {"trait_type": "Tier", "value": badge_info.get("tier", "common").title()},
                {"trait_type": "Earned Block", "value": block_height},
                {"trait_type": "Earned Date", "value": earned_date},
                {"trait_type": "Hardware", "value": miner_info.get("hardware", "Unknown")},
                {"trait_type": "Hardware Age", "value": f"{miner_info.get('age', 0)} years"},
            ],
            "properties": {
                "badge_id": badge_id,
    ...
    def check_badge_eligibility(self, miner_stats: Dict) -> List[str]:
        ...
        # Special badges
        if (
            "486" in miner_stats.get("hardware_model", "").lower()
            or "386" in miner_stats.get("hardware_model", "").lower()
        ):
    ...
    def create_badge_contract_data(self, badge_metadata: Dict) -> Dict:
        ...
        contract_data = {
            ...
            "metadata_hash": hashlib.sha256(json.dumps(badge_metadata, sort_keys=True).encode()).hexdigest(),
...
if __name__ == "__main__":
    ...
    if eligible_badges:
        metadata = generator.generate_badge_metadata(eligible_badges[0], miner_stats, 1000)
