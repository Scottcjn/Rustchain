...
class TestFeeManipulation(unittest.TestCase):
    ...
    def test_fee_not_in_signature(self):
        ...
        self.assertIn("fee_rtc", unsigned, "VULNERABILITY: fee_rtc not in signed message")

    def test_fee_inflation_possible(self):
        """Attacker can inflate fee without breaking signature"""
        self.db.get_unspent_for_address("alice")
        original_fee = 0.0001
        attacked_fee = 50.0
        amount = 10.0
        ...
        self.assertGreater(theft, 0, "Attacker steals difference between original and inflated fee")
