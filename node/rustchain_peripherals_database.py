...
CDROM_DATABASE: Dict[str, PeripheralEntry] = {
    ...
    "mitsumi_lu005": PeripheralEntry(
        "mitsumi_lu005", "Mitsumi LU005", "cdrom", 1992, 0.008, "LEGENDARY", "Proprietary interface"
    ),
    "mitsumi_crmc_lu005s": PeripheralEntry(
        "mitsumi_crmc_lu005s", "Mitsumi CRMC-LU005S", "cdrom", 1993, 0.007, "LEGENDARY", "Proprietary"
    ),
    "philips_cm205": PeripheralEntry(
        "philips_cm205", "Philips CM205", "cdrom", 1992, 0.008, "LEGENDARY", "LMS/Philips interface"
    ),
    "philips_cm206": PeripheralEntry(
        "philips_cm206", "Philips CM206", "cdrom", 1993, 0.007, "LEGENDARY", "LMS interface"
    ),
    ...
    "panasonic_cr521": PeripheralEntry(
        "panasonic_cr521", "Panasonic CR-521", "cdrom", 1992, 0.007, "LEGENDARY", "Proprietary SoundBlaster"
    ),
    "panasonic_cr522": PeripheralEntry(
        "panasonic_cr522", "Panasonic CR-522", "cdrom", 1993, 0.006, "RARE", "Proprietary"
    ),
    "aztech_cda268": PeripheralEntry(
        "aztech_cda268", "Aztech CDA-268", "cdrom", 1993, 0.006, "RARE", "Proprietary Aztech"
    ),
    ...
    "nakamichi_mj516": PeripheralEntry(
        "nakamichi_mj516", "Nakamichi MJ-5.16", "cdrom", 1995, 0.007, "LEGENDARY", "16-disc changer"
    ),
    "pioneer_drm604x": PeripheralEntry(
        "pioneer_drm604x", "Pioneer DRM-604X", "cdrom", 1994, 0.006, "RARE", "6-disc changer"
    ),
    ...
    "creative_cd220e": PeripheralEntry(
        "creative_cd220e", "Creative CD-220E", "cdrom", 1995, 0.003, "UNCOMMON", "2x IDE"
    ),
...
SOUND_CARD_DATABASE: Dict[str, PeripheralEntry] = {
    ...
    "gus_classic": PeripheralEntry(
        "gus_classic", "Gravis UltraSound Classic", "sound", 1992, 0.010, "MYTHIC", "1MB wavetable"
    ),
    ...
    "awe64_gold": PeripheralEntry(
        "awe64_gold", "Sound Blaster AWE64 Gold", "sound", 1996, 0.006, "RARE", "Gold edition"
    ),
    ...
    "turtle_beach_multisound": PeripheralEntry(
        "turtle_beach_multisound", "Turtle Beach MultiSound", "sound", 1993, 0.007, "LEGENDARY", "Motorola DSP"
    ),
    "turtle_beach_monterey": PeripheralEntry(
        "turtle_beach_monterey", "Turtle Beach Monterey", "sound", 1994, 0.006, "RARE", "Wavetable"
    ),
    "turtle_beach_tropez": PeripheralEntry(
        "turtle_beach_tropez", "Turtle Beach Tropez", "sound", 1995, 0.006, "RARE", "Dream SAM9407"
    ),
    "ensoniq_soundscape": PeripheralEntry(
        "ensoniq_soundscape", "Ensoniq Soundscape", "sound", 1994, 0.006, "RARE", "OTTO wavetable"
    ),
    "ensoniq_audio_pci": PeripheralEntry(
        "ensoniq_audio_pci", "Ensoniq AudioPCI", "sound", 1997, 0.004, "UNCOMMON", "ES1370"
    ),
    ...
    "vortex_advantage": PeripheralEntry(
        "vortex_advantage", "Aureal Vortex Advantage", "sound", 1999, 0.006, "RARE", "Budget A3D"
    ),
    ...
    "sblive_value": PeripheralEntry(
        "sblive_value", "Sound Blaster Live! Value", "sound", 1999, 0.002, "COMMON", "Budget Live"
    ),
    "generic_ac97": PeripheralEntry(
        "generic_ac97", "Generic AC'97 Audio", "sound", 1998, 0.001, "COMMON", "Integrated"
    ),
}
...
NETWORK_CARD_DATABASE: Dict[str, PeripheralEntry] = {
    ...
    "arcnet_datapoint": PeripheralEntry(
        "arcnet_datapoint", "Datapoint ARCnet", "network", 1977, 0.010, "MYTHIC", "Original ARCnet!"
    ),
    "arcnet_smc": PeripheralEntry(
        "arcnet_smc", "SMC ARCnet PC130", "network", 1985, 0.008, "LEGENDARY", "8-bit ARCnet"
    ),
    "arcnet_avery": PeripheralEntry(
        "arcnet_avery", "Avery ARCnet", "network", 1986, 0.007, "LEGENDARY", "16-bit ARCnet"
    ),
    "token_ring_16_4": PeripheralEntry(
        "token_ring_16_4", "IBM Token Ring 16/4", "network", 1985, 0.009, "LEGENDARY", "MCA Token Ring"
    ),
    "token_ring_isa": PeripheralEntry(
        "token_ring_isa", "IBM Token Ring ISA", "network", 1987, 0.008, "LEGENDARY", "ISA Token Ring"
    ),
    "token_ring_isa2": PeripheralEntry(
        "token_ring_isa2", "IBM Token Ring II ISA", "network", 1989, 0.007, "RARE", "16-bit Token Ring"
    ),
    # LocalTalk/AppleTalk - 0.006-0.008
    "localtalk_lc": PeripheralEntry(
        "localtalk_lc", "Apple LocalTalk LC", "network", 1990, 0.007, "LEGENDARY", "PDS LocalTalk"
    ),
    "localtalk_nubus": PeripheralEntry(
        "localtalk_nubus", "Apple LocalTalk NuBus", "network", 1988, 0.007, "LEGENDARY", "NuBus"
    ),
    "farallon_pn": PeripheralEntry(
        "farallon_pn", "Farallon PhoneNET", "network", 1987, 0.007, "LEGENDARY", "LocalTalk over RJ-11"
    ),
    "dayna_etherprint": PeripheralEntry(
        "dayna_etherprint", "Dayna EtherPrint", "network", 1990, 0.006, "RARE", "LocalTalk bridge"
    ),
    # Early Ethernet - 0.006-0.008
    "3c501": PeripheralEntry(
        "3c501", "3Com 3C501 EtherLink", "network", 1982, 0.008, "LEGENDARY", "Original EtherLink"
    ),
    ...
    "3c905": PeripheralEntry(
        "3c905", "3Com 3C905 Fast EtherLink", "network", 1996, 0.003, "UNCOMMON", "PCI 100Base-TX"
    ),
    "intel_etherexpress": PeripheralEntry(
        "intel_etherexpress", "Intel EtherExpress", "network", 1991, 0.004, "UNCOMMON", "ISA"
    ),
    "intel_etherexpress_pro": PeripheralEntry(
        "intel_etherexpress_pro", "Intel EtherExpress Pro", "network", 1994, 0.003, "UNCOMMON", "ISA/PCI"
    ),
    ...
    "generic_100mbit": PeripheralEntry(
        "generic_100mbit", "Generic 100Mbit NIC", "network", 1998, 0.001, "COMMON", "Standard"
    ),
}
...
STORAGE_CONTROLLER_DATABASE: Dict[str, PeripheralEntry] = {
    # Early SCSI - max 0.01
    "adaptec_aha1540": PeripheralEntry(
        "adaptec_aha1540", "Adaptec AHA-1540", "storage", 1990, 0.009, "LEGENDARY", "ISA SCSI-1"
    ),
    "adaptec_aha1542": PeripheralEntry(
        "adaptec_aha1542", "Adaptec AHA-1542", "storage", 1992, 0.008, "LEGENDARY", "ISA SCSI-2 bus master"
    ),
    "adaptec_aha2940": PeripheralEntry(
        "adaptec_aha2940", "Adaptec AHA-2940", "storage", 1994, 0.006, "RARE", "PCI Fast SCSI"
    ),
    "adaptec_aha2940uw": PeripheralEntry(
        "adaptec_aha2940uw", "Adaptec AHA-2940UW", "storage", 1996, 0.005, "UNCOMMON", "PCI Ultra Wide"
    ),
    "buslogic_bt542": PeripheralEntry(
        "buslogic_bt542", "BusLogic BT-542", "storage", 1991, 0.008, "LEGENDARY", "ISA SCSI"
    ),
    "buslogic_bt946c": PeripheralEntry(
        "buslogic_bt946c", "BusLogic BT-946C", "storage", 1994, 0.006, "RARE", "PCI SCSI"
    ),
    "ncr_53c810": PeripheralEntry("ncr_53c810", "NCR 53C810", "storage", 1993, 0.006, "RARE", "PCI SCSI"),
    "symbios_53c875": PeripheralEntry(
        "symbios_53c875", "Symbios 53C875", "storage", 1995, 0.005, "UNCOMMON", "PCI Ultra SCSI"
    ),
    # EISA/MCA RAID - 0.008-0.009
    "dpt_pm2024": PeripheralEntry("dpt_pm2024", "DPT PM2024", "storage", 1992, 0.009, "LEGENDARY", "EISA RAID"),
    "dpt_pm3334uw": PeripheralEntry(
        "dpt_pm3334uw", "DPT PM3334UW", "storage", 1996, 0.007, "RARE", "PCI Ultra Wide RAID"
    ),
    "compaq_smart_array": PeripheralEntry(
        "compaq_smart_array", "Compaq Smart Array", "storage", 1993, 0.008, "LEGENDARY", "EISA RAID"
    ),
    "mylex_acceleraid": PeripheralEntry(
        "mylex_acceleraid", "Mylex AcceleRAID", "storage", 1995, 0.007, "RARE", "PCI RAID"
    ),
    # Early IDE - 0.004-0.006
    "promise_dc4030": PeripheralEntry(
        "promise_dc4030", "Promise DC4030", "storage", 1993, 0.006, "RARE", "VLB IDE cache"
    ),
    ...
    "promise_ultra33": PeripheralEntry(
        "promise_ultra33", "Promise Ultra33", "storage", 1997, 0.003, "UNCOMMON", "ATA-33"
    ),
    "promise_ultra66": PeripheralEntry(
        "promise_ultra66", "Promise Ultra66", "storage", 1999, 0.002, "COMMON", "ATA-66"
    ),
    # Standard - 0.001-0.002
    "generic_ide": PeripheralEntry(
        "generic_ide", "Generic IDE Controller", "storage", 1995, 0.001, "COMMON", "Standard"
    ),
    "generic_sata": PeripheralEntry(
        "generic_sata", "Generic SATA Controller", "storage", 2003, 0.001, "COMMON", "Standard"
    ),
}
...
MODEM_DATABASE: Dict[str, PeripheralEntry] = {
    ...
    "hayes_smartmodem": PeripheralEntry(
        "hayes_smartmodem", "Hayes Smartmodem 1200", "modem", 1982, 0.008, "MYTHIC", "Original AT commands"
    ),
    "hayes_ultra_96": PeripheralEntry(
        "hayes_ultra_96", "Hayes Ultra 96", "modem", 1989, 0.007, "LEGENDARY", "9600 bps"
    ),
    "hayes_optima": PeripheralEntry("hayes_optima", "Hayes Optima 288", "modem", 1994, 0.005, "RARE", "28.8k V.34"),
    "telebit_trailblazer": PeripheralEntry(
        "telebit_trailblazer", "Telebit TrailBlazer", "modem", 1986, 0.008, "LEGENDARY", "PEP protocol"
    ),
    "telebit_t2500": PeripheralEntry(
        "telebit_t2500", "Telebit T2500", "modem", 1990, 0.007, "LEGENDARY", "V.32bis + PEP"
    ),
    "usr_courier": PeripheralEntry("usr_courier", "USR Courier HST", "modem", 1988, 0.007, "LEGENDARY", "HST protocol"),
    "usr_courier_dual": PeripheralEntry(
        "usr_courier_dual", "USR Courier Dual Standard", "modem", 1992, 0.006, "RARE", "HST + V.32bis"
    ),
    "usr_sportster": PeripheralEntry(
        "usr_sportster", "USR Sportster 14.4", "modem", 1993, 0.004, "UNCOMMON", "Consumer 14.4k"
    ),
    "usr_sportster_288": PeripheralEntry(
        "usr_sportster_288", "USR Sportster 28.8", "modem", 1995, 0.003, "UNCOMMON", "V.34"
    ),
...
SPECIALTY_DATABASE: Dict[str, PeripheralEntry] = {
    ...
    "video_spigot": PeripheralEntry(
        "video_spigot", "Creative Video Spigot", "capture", 1991, 0.007, "LEGENDARY", "Early video capture"
    ),
    "intel_smart_video": PeripheralEntry(
        "intel_smart_video", "Intel Smart Video Recorder", "capture", 1993, 0.006, "RARE", "Indeo capture"
    ),
    ...
    "dvd_express": PeripheralEntry(
        "dvd_express", "Creative DVD Encore", "mpeg", 1998, 0.005, "UNCOMMON", "Hardware MPEG-2"
    ),
    "cinemaster": PeripheralEntry(
        "cinemaster", "Sigma Designs Hollywood+", "mpeg", 1997, 0.005, "UNCOMMON", "DVD decoder"
    ),
    # Amiga accelerators - 0.008-0.01
    "blizzard_1230": PeripheralEntry(
        "blizzard_1230", "Blizzard 1230 IV", "amiga_accel", 1995, 0.008, "LEGENDARY", "68030 accelerator"
    ),
    "blizzard_1260": PeripheralEntry(
        "blizzard_1260", "Blizzard 1260", "amiga_accel", 1996, 0.009, "MYTHIC", "68060 accelerator"
    ),
    "cyberstorm_mk2": PeripheralEntry(
        "cyberstorm_mk2", "CyberStorm MK II", "amiga_accel", 1996, 0.009, "MYTHIC", "68060 for A4000"
    ),
    "cyberstorm_ppc": PeripheralEntry(
        "cyberstorm_ppc", "CyberStorm PPC", "amiga_accel", 1997, 0.010, "MYTHIC", "PowerPC for A4000!"
    ),
    "blizzard_ppc": PeripheralEntry(
        "blizzard_ppc", "Blizzard PPC", "amiga_accel", 1997, 0.010, "MYTHIC", "PowerPC for A1200!"
    ),
    ...
    "cybervision_64": PeripheralEntry(
        "cybervision_64", "CyberVision 64", "amiga_gfx", 1995, 0.008, "LEGENDARY", "S3 Vision964"
    ),
    "cybervision_3d": PeripheralEntry(
        "cybervision_3d", "CyberVision 64/3D", "amiga_gfx", 1997, 0.008, "LEGENDARY", "S3 ViRGE"
    ),
    # Mac accelerators - 0.006-0.008
    "daystar_turbo": PeripheralEntry(
        "daystar_turbo", "DayStar Turbo 040", "mac_accel", 1993, 0.007, "LEGENDARY", "68040 upgrade"
    ),
    "daystar_genesis": PeripheralEntry(
        "daystar_genesis", "DayStar Genesis MP", "mac_accel", 1996, 0.008, "LEGENDARY", "Dual 604e!"
    ),
    "sonnet_crescendo": PeripheralEntry(
        "sonnet_crescendo", "Sonnet Crescendo G3", "mac_accel", 1998, 0.006, "RARE", "G3 upgrade"
    ),
    "newertech_maxpower": PeripheralEntry(
        "newertech_maxpower", "NewerTech MAXpower", "mac_accel", 1997, 0.006, "RARE", "G3 for PCI Macs"
    ),
    # PowerVR / Sega tile-based rendering GPUs - MYTHIC tier
    "powervr_pcx1": PeripheralEntry(
        "powervr_pcx1",
        "NEC PowerVR PCX1 (Diamond Edge 3D)",
        "specialty",
        1996,
        0.010,
        "MYTHIC",
    ...
    "powervr_pcx2": PeripheralEntry(
        "powervr_pcx2", "NEC PowerVR PCX2 (Matrox m3D)", "specialty", 1997, 0.009, "MYTHIC", "PowerVR Series 2"
    ),
    "powervr_vf_bundle": PeripheralEntry(
        "powervr_vf_bundle",
        "Sega Virtua Fighter Bundle Card",
        "specialty",
        1996,
        0.010,
        "MYTHIC",
        "Rare promo bundle with game port",
    ),
    "videologic_apocalypse": PeripheralEntry(
        "videologic_apocalypse", "VideoLogic Apocalypse 3D", "specialty", 1996, 0.009, "MYTHIC", "UK PowerVR variant"
    ),
    "apocalypse_5d": PeripheralEntry(
        "apocalypse_5d", "VideoLogic Apocalypse 5D", "specialty", 1997, 0.008, "LEGENDARY", "PowerVR + sound"
    ),
}
...
def get_highest_bonus_peripherals(limit: int = 20) -> List[dict]:
    ...
    sorted_peripherals = sorted(ALL_PERIPHERALS.values(), key=lambda x: x.bonus, reverse=True)
