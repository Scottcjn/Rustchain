...
# ── Ed25519 identity binding & phased attestation enforcement (#8016 hardened) ──
# Background: miner_attest_recent.signing_pubkey is the authority the /epoch/enroll
# path verifies enrollment signatures against, so pinning the WRONG key is a
# consensus/rewards hazard (first-signer hijack). The helpers below implement a
# phased rollout, a strict self-certifying identity gate, and a freeze/generation
# ledger for the admin unpin/rotate path.
