...
def create_agentkit_wallet():
    ...
    try:
        ...
        raise RuntimeError("coinbase-agentkit not installed. Run: pip install coinbase-agentkit") from e
    except Exception as e:
        raise RuntimeError(f"Failed to create Coinbase wallet: {e}") from e
